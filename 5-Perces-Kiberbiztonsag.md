...
<details>
    <summary>Mindenképp!</summary>

|Teendő|Fontosság |Android|Windows|iOS|macOS|Linux|
|--|--|--|--|--|--|--|
|Használj privát, biztonságos és titkosított üzenetküldő alkalmazásokat.|Mindenképp|[Signal](https://signal.org/) / [Simplex](https://simplex.chat/) / [Briar](https://briarproject.org/)|[Signal](https://signal.org/) / [Simplex](https://simplex.chat/) / [Briar](https://briarproject.org/)|[Signal](https://signal.org/) / [Simplex](https://simplex.chat/) / [Briar](https://briarproject.org/)|[Signal](https://signal.org/) / [Simplex](https://simplex.chat/) / [Briar](https://briarproject.org/)|[Signal](https://signal.org/) / [Simplex](https://simplex.chat/) / [Briar](https://briarproject.org/)|
|Fájlok megosztására NE erre “szakosodott” weboldalakat használj (pl. WeTransfer, SendBig). Inkább:|Mindenképp|[OnionShare](https://onionshare.org/) / [Syncthing](https://syncthing.net/downloads/) / [Send](https://send.vis.ee/)|[OnionShare](https://onionshare.org/) / [Syncthing](https://syncthing.net/downloads/) / [Send](https://send.vis.ee/)| [OnionShare](https://onionshare.org/) / [Syncthing](https://syncthing.net/downloads/) / [Send](https://send.vis.ee/)| [OnionShare](https://onionshare.org/) / [Syncthing](https://syncthing.net/downloads/) / [Send](https://send.vis.ee/)|[OnionShare](https://onionshare.org/) / [Syncthing](https://syncthing.net/downloads/) / [Send](https://send.vis.ee/)|
| Telepíts és kalibrálj egy megbízható vírusírtó alkalmazást! | Mindeképp | | | | 
| Használj jelszókezelő alkalmazást! | Mindeképp | [Proton Pass](https://proton.me/pass/download) / [Nord Pass](https://nordpass.com/) | [Proton Pass](https://proton.me/pass/download) / [KeePassX](https://keepassxc.org/download/#windows) / [Bitwarden](https://apps.microsoft.com/detail/9pjsdv0vpk04?ocid=webpdpshare) | [iOS beépített](https://support.apple.com/hu-hu/104955) / [Proton Pass](https://proton.me/pass/download) | [Proton Pass](https://proton.me/pass/download) / [Nord Pass](https://nordpass.com/) | [Proton Pass](https://proton.me/pass/download) / [KeePassXC](https://keepassxc.org/download/#linux) |
| Állìts be két-faktoros hitelesítést (2FA) minden fontos fiókodon! | Mindenképp  | [Aegis](https://getaegis.app/) / [EnteAuth](https://ente.io/auth/) | | [Google Authenticator](https://apps.apple.com/us/app/google-authenticator/id388497605) | [Google Authenticator](https://apps.apple.com/us/app/google-authenticator/id388497605) | [Google PAM SSH-hoz](https://www.redhat.com/sysadmin/mfa-linux) | 
| Használj egy megbízható VPN-t! | Mindenképp | [Proton VPN](https://protonvpn.com/) / [NordVPN](https://nordvpn.com/download/) | [Proton VPN](https://protonvpn.com/) / [NordVPN](https://nordvpn.com/download/) | [Proton VPN](https://protonvpn.com/) / [NordVPN](https://nordvpn.com/download/) | [Proton VPN](https://protonvpn.com/) / [NordVPN](https://nordvpn.com/download/) | [Proton VPN](https://protonvpn.com/) / [NordVPN](https://nordvpn.com/download/) |
|    Korlátozd alkalmazásaid hozzáférési engedélyeit (ezt havonta meg kell ismételned)! | Mindenképp | Beállítások > Alkalmazásengedélyek | | Beállítások > Biztonsági Beállítások |
| Töröld nem használt alkalmazásaidat! | Mindenképp | 
| Állíts be [erős jelszót](https://nki.gov.hu/it-biztonsag/tartalom/eszkoztar/jelszohasznalat/) és biometrikus azonosítást bejelentkezéskor! | Mindenképp | 
| Használj privát és biztonságos és titkosított üzenetküldő alkalmazásokat! | Mindenképp | [Signal](https://signal.org/) / [SimpleX Chat](https://simplex.chat/) / [Briar](https://briarproject.org/) | [Signal](https://signal.org/) | [Signal](https://signal.org/) / [SimpleX Chat](https://simplex.chat/) | [Signal](https://signal.org/) / [SimpleX Chat](https://simplex.chat/) | [Signal](https://signal.org/) |
| Töröld a metadatokat és anonimizáld képeidet, videóidat mielőtt megosztod őket az interneten! | Mindenképp | [Exif Eraser](https://play.google.com/store/apps/details?id=com.none.tom.exiferaser), [PrivacyBlur](https://play.google.com/store/apps/details?id=de.mathema.privacyblur) | [Exif Eraser](https://www.exiferaser.com/) | [Photo Metadata EXIF Remover](https://apps.apple.com/us/app/photo-metadata-exif-remover/id1079710135), [PrivacyBlur](https://apps.apple.com/us/app/privacyblur/id1536274106) / [Metapho](https://apps.apple.com/us/app/metapho/id914457352) | | [Metadata Cleaner](https://metadatacleaner.romainvigier.fr/) / [ExifTool](https://exiftool.org/) |     

</details>

<details>
    <summary>Opcionális</summary>

|Teendő|Fontosság |Android|Windows|iOS|macOS|Linux|
|--|--|--|--|--|--|--|
| Használj titkosított jegyzetfüzet alkalmazást! | Opcionális |  [Standard Notes](https://standardnotes.com/) / [Tella](https://play.google.com/store/apps/details?id=org.hzontal.tella) / [Joplin](https://joplinapp.org/help/install/) |  [Standard Notes](https://standardnotes.com/) / [Joplin](https://joplinapp.org/help/install/) |  [Standard Notes](https://standardnotes.com/) / [Tella](https://apps.apple.com/us/app/tella-document-protect/id1598152580) / [Joplin](https://joplinapp.org/help/install/) |   [Standard Notes](https://standardnotes.com/) / [Joplin](https://joplinapp.org/help/install/) |  [Standard Notes](https://standardnotes.com/) / [Joplin](https://joplinapp.org/help/install/) |
| Telepíts és konfigurálj egy tűzfal alkalmazást, hogy limitáld adataid szivárgását! | Opcionális | [TC Tracker Control](https://trackercontrol.org/) / [RethinkDNS](https://rethinkdns.com/app) | [Windows Defender](https://support.microsoft.com/en-us/windows/turn-microsoft-defender-firewall-on-or-off-ec0844f7-aebd-0583-67fe-601ecf5d774f) | | | [(G)ufw](https://help.ubuntu.com/community/Gufw) | 
| Használj biztonságos email szolgáltatásokat! | Opcionális | [Proton Mail](https://proton.me/mail/download) / [Mailbox.org](https://mailbox.org/en/) | [Proton Mail](https://proton.me/mail/download) / [Mailbox.org](https://mailbox.org/en/) | [Proton Mail](https://proton.me/mail/download) / [Mailbox.org](https://mailbox.org/en/) | [Proton Mail](https://proton.me/mail/download) / [Mailbox.org](https://mailbox.org/en/) | [Proton Mail](https://proton.me/mail/download) / [Mailbox.org](https://mailbox.org/en/) |
| Használj egy biztonságos internetes böngészőt jó biztonsági és adatvédelmi beállításokkal! | Opcionális | [Firefox](https://www.mozilla.org/hu/firefox/new/) / [Brave](https://play.google.com/store/apps/details?id=com.brave.browser) / [DuckDuckGo](https://play.google.com/store/apps/details?id=com.duckduckgo.mobile.android) | [Firefox](https://www.mozilla.org/hu/firefox/new/) [Brave](https://apps.microsoft.com/detail/xp8c9qzms2pc1t?hl=en-us&gl=HU) / [DuckDuckGo](https://apps.microsoft.com/detail/9n74nhxch1n6?ocid=webpdpshare) | [Safari](https://www.apple.com/safari/) with [AdGuard](https://apps.apple.com/us/app/adguard-adblock-privacy/id1047223162) / [Firefox](https://apps.apple.com/us/app/firefox-private-safe-browser/id989804926) [Brave](https://apps.apple.com/us/app/brave-private-web-browser-vpn/id1052879175) / [DuckDuckGo](https://apps.apple.com/us/app/duckduckgo-private-browser/id663592361) | [Safari](https://www.apple.com/safari/) with [AdGuard](https://apps.apple.com/us/app/adguard-adblock-privacy/id1047223162) / [Firefox](https://apps.apple.com/us/app/firefox-private-safe-browser/id989804926) [Brave](https://apps.apple.com/us/app/brave-private-web-browser-vpn/id1052879175) / [DuckDuckGo](https://apps.apple.com/us/app/duckduckgo-private-browser/id663592361) | [Firefox](https://www.mozilla.org/hu/firefox/new/) / Tor | 
| Közösségi média fiókjaidat ne alkalmazásokból, hanem internetes böngésződből használd! | Opcionális | 

</details>

<details>
    <summary>Haladó</summary>

|Teendő|Fontosság |Android|Windows|iOS|macOS|Linux|
|--|--|--|--|--|--|--|
| Használj izolációs (sandbox) technológiát, hogy elválaszd munkahelyi adataidat személyes adataidtól! | Haladó | [Shelter](https://github.com/PeterCxy/Shelter) / [Insular](gitlab.com/secure-system/Insular) | | | | [Firejail](https://firejail.wordpress.com/) / [Apparmor](https://apparmor.net/) | 
| Használj eldobható telefonszámokat és email címeket online regisztrációidnál! | Haladó | [Firefox Relay](https://relay.firefox.com/) / [Proton Pass](https://proton.me/pass/aliases) | [Firefox Relay](https://relay.firefox.com/) / [Proton Pass](https://proton.me/pass/aliases) | [Firefox Relay](https://relay.firefox.com/) / [Proton Pass](https://proton.me/pass/aliases) | [Firefox Relay](https://relay.firefox.com/) / [Proton Pass](https://proton.me/pass/aliases) | [Firefox Relay](https://relay.firefox.com/) / [Proton Pass](https://proton.me/pass/aliases) | 
| Használj decentralizált, adatvédelmet preferáló alkalmazás áruházakat! | Haladó | [Aurora Store](https://aurorastore.org/) / [F-Droid](https://f-droid.org/) |
| Titkosítsd képeid, videóid, dokumentumaid és hangfelvételeid helyileg! | Haladó | [Tella](https://play.google.com/store/apps/details?id=org.hzontal.tella) | [Cryptomator (Cloud)](https://cryptomator.org/downloads/) | [VeraCrypt](https://veracrypt.fr/en/Home.html) / [Picocrypt](https://github.com/Picocrypt/Picocrypt) / [Cryptomator](https://cryptomator.org/) | [Tella](https://apps.apple.com/us/app/tella-document-protect/id1598152580) / [Cryptomator (Cloud)](https://apps.apple.com/us/app/cryptomator/id1560822163) | [VeraCrypt](https://veracrypt.fr/en/Home.html) / [Picocrypt](https://github.com/Picocrypt/Picocrypt) / [Cryptomator](https://cryptomator.org/) | [VeraCrypt](https://veracrypt.fr/en/Home.html) / [Picocrypt](https://github.com/Picocrypt/Picocrypt) / [Cryptomator](https://cryptomator.org/) |
</details>
